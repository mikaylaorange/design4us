  ...
  return (
    <Container id="about">
      ...
      <TextConatiner>
        ...
        <HelperText>
          This event was inspired by a Human-Computer Interaction class taken by
          the organizes during the{" "}
          <HyperLink href="https://buildyourfuture.withgoogle.com/programs/tech-exchange/">
            {" "}
